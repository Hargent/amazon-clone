      ...
      <div className="home__categories__container">
        <div className="row1__a home__category__item">
          <div className="home__category__header">
            ...
            <img
              src="https://m.media-amazon.com/images/I/51yeHwJttJL._AC_SY230_.jpg"
              alt="DOD"
            />
            <a>See all deals</a>
          </div>
          ...
          <div className="home__category__header">
            ...
            <div className="row1__b__container">
              <div className="row1__b__i">
                <img
                  src="https://images-na.ssl-images-amazon.com/images/G/01/kindle/journeys/ZDU3MTYxZjAt/ZDU3MTYxZjAt-MDhkNGRlMmEt-w186._SY116_CB625165837_.jpg"
                  alt="ale"
                />
              ...
              <div className="row1__b__ii">
                <img
                  src="https://images-na.ssl-images-amazon.com/images/G/01/kindle/journeys/ZDU3MTYxZjAt/ZDU3MTYxZjAt-OGNlNWQ4NTQt-w186._SY116_CB645954746_.jpg"
                  alt="/"
                />
              ...
              <div className="row1__b__iii">
                <img
                  src="https://images-na.ssl-images-amazon.com/images/G/01/kindle/journeys/ZDU3MTYxZjAt/ZDU3MTYxZjAt-ZDlmMmNlMmEt-w186._SY116_CB645954746_.jpg"
                  alt=""
                />
              ...
              <div className="row1__b__iv">
                <img
                  src="https://images-na.ssl-images-amazon.com/images/G/01/kindle/journeys/ZDU3MTYxZjAt/ZDU3MTYxZjAt-ZWY2MzE2NWIt-w186._SY116_CB645954746_.jpg"
                  alt=""
                />
          ...
          <div className="home__category__header">
            ...
            <div className="row1__c__container">
              <div className="row1__c__i">
                <img
                  src="https://images-na.ssl-images-amazon.com/images/G/01/US-hq/2022/img/Alexa_Voice_Service_AVS_/XCM_CUTTLE_1417348_2250222_US_CUTTLE_186x116_1X_en_US._SY116_CB626537642_.jpg"
                  alt="ale"
                />
                <h6>Speakers</h6>
              </div>
